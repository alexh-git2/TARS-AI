...
def load_config():
    ...
    required_sections = ["CONTROLS", "STT", "CHAR", "LLM", "VISION", "EMOTION", "TTS"]
    missing_sections = [
    ...
    config_dict = {
        ...
        "STT": {
            ...
            "sherpa_onnx_denoise": config.get(
                "STT", "sherpa_onnx_denoise", fallback="False"
            ),
            "sherpa_onnx_punctuation": config.get(
                "STT", "sherpa_onnx_punctuation", fallback="False"
            ),
            ...
            "vad_transcript_verify": config.get(
                "STT", "vad_transcript_verify", fallback="False"
            ),
            "vad_presence_gate": config.get("STT", "vad_presence_gate", fallback="off"),
            "vad_speaker_verify": config.get(
                "STT", "vad_speaker_verify", fallback="off"
            ),
            "vad_speaker_threshold": config.get(
                "STT", "vad_speaker_threshold", fallback="0.60"
            ),
            "enable_bargein": config.getboolean("STT", "enable_bargein", fallback=True),
            "bargein_mode": config.get("STT", "bargein_mode", fallback="fuzzy"),
            "bargein_sensitivity": config.getint(
                "STT", "bargein_sensitivity", fallback=5
            ),
            "vad_method": config["STT"]["vad_method"],
            "speechdelay": int(config["STT"]["speechdelay"]),
            "speaker_id_enabled": config.get(
                "STT", "speaker_id_enabled", fallback="False"
            ),
            "speaker_id_threshold": config.get(
                "STT", "speaker_id_threshold", fallback="0.75"
            ),
        ...
        "CHAR": {
            ...
            "enable_thinking_responses": config.getboolean(
                "CHAR", "enable_thinking_responses", fallback=True
            ),
        ...
        "VISION": {
            ...
            "vision_processor": config.get(
                "VISION", "vision_processor", fallback="blip"
            ),
            "use_llm_backend": config.getboolean(
                "VISION", "use_llm_backend", fallback=True
            ),
            "external": config.get("VISION", "vision_processor", fallback="blip")
            == "external",
            "base_url": config.get("VISION", "base_url", fallback=""),
            "vision_model": config.get("VISION", "vision_model", fallback=""),
            "vision_max_tokens": config.getint(
                "VISION", "vision_max_tokens", fallback=150
            ),
        },
        "EMOTION": {
            "enabled": config.getboolean("EMOTION", "enabled"),
            "emotion_method": config.get(
                "EMOTION", "emotion_method", fallback="classifier"
            ),
        ...
        "TTS": TTSConfig.from_config_dict(
            {
                ...
                "piper_multispeaker": config.getboolean(
                    "TTS", "piper_multispeaker", fallback=False
                ),
                "piper_speaker_joy": config.getint(
                    "TTS", "piper_speaker_joy", fallback=0
                ),
                "piper_speaker_neutral": config.getint(
                    "TTS", "piper_speaker_neutral", fallback=1
                ),
                "piper_speaker_fear": config.getint(
                    "TTS", "piper_speaker_fear", fallback=2
                ),
                "piper_speaker_curiosity": config.getint(
                    "TTS", "piper_speaker_curiosity", fallback=3
                ),
                "piper_speaker_love": config.getint(
                    "TTS", "piper_speaker_love", fallback=4
                ),
                "piper_speaker_sadness": config.getint(
                    "TTS", "piper_speaker_sadness", fallback=5
                ),
                "piper_speaker_surprise": config.getint(
                    "TTS", "piper_speaker_surprise", fallback=6
                ),
                "piper_speaker_anger": config.getint(
                    "TTS", "piper_speaker_anger", fallback=7
                ),
            }
        ),
        "RAG": {
        ...
        "ACCESS": {
            "webui_enabled": config.getboolean(
                "ACCESS", "webui_enabled", fallback=True
            ),
            "webui_port": config.getint("ACCESS", "webui_port", fallback=80),
            "webui_password": config.get(
                "ACCESS", "webui_password", fallback="tarspass1234"
            ),
            "webui_theme": config.get("ACCESS", "webui_theme", fallback="default"),
            "remote_access_enabled": config.getboolean(
                "ACCESS", "remote_access_enabled", fallback=False
            ),
        },
        "UI": {
        ...
        "BATTERY": {
            "battery_enabled": config.getboolean(
                "BATTERY", "battery_enabled", fallback=False
            ),
            "battery_auto_shutdown": config.getboolean(
                "BATTERY", "battery_auto_shutdown", fallback=False
            ),
            "battery_capacity_mAh": int(
                config.get("BATTERY", "battery_capacity_mAh", fallback="3000")
            ),
            "battery_initial_voltage": float(
                config.get("BATTERY", "battery_initial_voltage", fallback="12")
            ),
            "battery_cutoff_voltage": float(
                config.get("BATTERY", "battery_cutoff_voltage", fallback="10")
            ),
        },
        "GEO_SERVICES": {
...
CONFIG_METADATA = {
    ...
    "STT": {
        ...
        "use_indicators": {
            "group": "vad",
            "group_label": "End-of-Speech Detection",
    ...
    "TTS": {
        ...
        "piper_speaker_joy": {
            ...
            "depends_on": [
                {"field": "ttsoption", "values": ["piper"]},
                {"field": "piper_multispeaker", "values": ["true", "True"]},
            ],
    ...
    "EMOTION": {
        ...
        "emotion_method": {
            ...
            "option_labels": {
                "classifier": "Classifier (local model)",
                "llm": "LLM (from response)",
            },
            "label": "Detection Method",
    ...
    "VISION": {
        ...
        "use_llm_backend": {
            ...
            "depends_on": [
                {"field": "enabled", "values": ["True", "true"]},
                {"field": "vision_processor", "values": ["openai", "llm"]},
            ],
        ...
        "base_url": {
            ...
            "depends_on": [
                {"field": "enabled", "values": ["True", "true"]},
                {"field": "use_llm_backend", "values": ["False", "false"]},
                {"field": "vision_processor", "values": ["external", "openai", "llm"]},
            ],
        ...
        "vision_max_tokens": {
            ...
            "depends_on": [
                {"field": "enabled", "values": ["True", "true"]},
                {"field": "vision_processor", "values": ["openai", "llm", "external"]},
            ],
    ...
    "RAG": {
        ...
        "embedding_url": {
            ...
            "depends_on": [
                {"field": "enabled", "values": ["True", "true"]},
                {"field": "embedding_source", "values": ["external"]},
            ],
